...
######################################################################################################################################################
#######REQUIREMENTS###################################################################################################################################                            
#######--count_file     reads counts file for deseq2                                                                                          ######## 
#######--coldata_file   sample coldata file                                                                                                   ######## 
#######--sample_con     sample condition for deseq2.eg.'tumor-normal',the name of sample condition must same with the condition in coldatafile######## 
#######--outprefix      results prefix for output file                                                                                        ######## 
######################################################################################################################################################
